...
#define ui_sstore1 "WEST+5:[10*PIXEL_MULTIPLIER],SOUTH:[5*PIXEL_MULTIPLIER]"
#define ui_id "WEST+6:[12*PIXEL_MULTIPLIER],SOUTH:[5*PIXEL_MULTIPLIER]"
#define ui_belt "WEST+7:[14*PIXEL_MULTIPLIER],SOUTH:[5*PIXEL_MULTIPLIER]"
